...
#SBATCH --output=/work/cvcs2026/stochastic_parrots/ktotaro/logs/train_ti_%j.out
#SBATCH --error=/work/cvcs2026/stochastic_parrots/ktotaro/logs/train_ti_%j.err

mkdir -p /work/cvcs2026/stochastic_parrots/ktotaro/logs

cd /work/cvcs2026/stochastic_parrots/ktotaro
